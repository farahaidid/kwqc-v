            ...
            <div class="col-12 col-md-9 col-lg-7">
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <b-card header-bg-variant="light" text-variant="black" header="SAW" class="text-center">
                                <b-card-text>
                                    <div class="row">
                                        <div class="col-2">
                                            <h6>
                                                <b-badge variant="light">{{calculateBadge('saw','validity')}}</b-badge>
                                            </h6>
                                        </div>
                                        <div class="col-2">
                                            <h6>
                        ...
                        <tile-spinner class="text-center" v-if="loading" />
                        <hr>
...
export default {
    ...
    methods:{
        ...
        calculateBadge(key,type){
            let emps = this.employees.filter(e => moment(e[key],'YYYY-MM-DD').format('X') != 'Invalid date')
            let fiveM = moment().subtract(5,'months').format('X')
            let sixM = moment().subtract(6,'months').format('X')
            let twelveM = moment().subtract(12,'months').format('X')
            if(type == 'validity'){
                return emps ? emps.length : 0
            }else if(type == 'lt5'){
                let lt5 = emps.filter(e => moment(e[key],'YYYY-MM-DD').format('X') >= fiveM)
                return lt5 ? lt5.length : 0
            }else if(type == '5bt6'){
                let bt6 = emps.filter(e => moment(e[key],'YYYY-MM-DD').format('X') < fiveM && moment(e[key],'YYYY-MM-DD').format('X') > sixM)
                return bt6 ? bt6.length : 0
            }else if(type == '6bt12'){
                let bt12 = emps.filter(e => moment(e[key],'YYYY-MM-DD').format('X') <= sixM && moment(e[key],'YYYY-MM-DD').format('X') > twelveM)
